...
if [ ! -d "%{buildroot}%{_datadir}/%{name}/%{version}/tests/rdo310" ];then
     mkdir -p %{buildroot}%{_datadir}/%{name}/%{version}/tests/rdo310
fi
...
* Tue Mar 14 2023 RDO <dev@lists.rdoproject.org> 0.8.36-1
- Update to 0.8.36
